...
printf("2 - Consulta de informacoes de aluno\n");
printf("3 - Atualizacao de informacoes de aluno\n");
printf("4 - Remocao de aluno\n");
printf("5 - Relatorio\n");
printf("6 - Sair\n");
scanf("%i", &resp);
...
{
printf("A quantidade maxima de alunos (%i) foi atingida!\n\n",QTD_ALUNOS);
}
else
{
...
{
imprimir_dados(pesq);
printf("\n\nEsta matricula ja existe cadastrada!\n\n");
}
else
{
printf("Nome: ");
...
break;
case 6:
// não faz nada, pois sairá do loop
break;
default:
